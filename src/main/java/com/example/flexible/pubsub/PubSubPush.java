...
public class PubSubPush extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		String pubsubVerificationToken = "123456789";// System.getenv("PUBSUB_VERIFICATION_TOKEN");
		...
		try {
			...
			// 200, 201, 204, 102 status codes are interpreted as success by the Pub/Sub
			// system
	...
	public Message getMessage(HttpServletRequest request) throws IOException {
		String requestBody = request.getParameter("payload");
